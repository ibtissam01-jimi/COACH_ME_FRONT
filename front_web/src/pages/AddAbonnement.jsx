...
//   const { list: coachs } = useSelector((state) => state.coachs);
...
//     e.preventDefault();
//     try {
//       // Envoie à ton slice createAbonnement ici
//       console.log('Submitting abonnement:', formData);
//       // dispatch(createAbonnement(formData)).unwrap();
...
//   const { plans } = useSelector((state) => state.plans);
//   const { coachs } = useSelector((state) => state.coachs); // ✅ Assure-toi que ce soit bien 'coachs'
...
//       const payload = {
//         ...formData,
//         user_id: user.id, // 🔥 Ajout automatique de l'id utilisateur connecté
//       };
...
//     {coachs.map((coach) => (
//       <SelectItem key={coach.id} value={String(coach.id)}>
//         {`${coach.prenom} ${coach.nom}`}  {/* Affiche le prénom et le nom du coach */}
//       </SelectItem>
//     ))}
//   </SelectContent>
// </Select>
