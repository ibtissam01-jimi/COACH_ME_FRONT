...
export const forgotPassword = createAsyncThunk('auth/forgotPassword', async (email, thunkAPI) => {
  try {
    ...
    return thunkAPI.rejectWithValue(err.response?.data?.message || 'Erreur lors de l’envoi de l’email');
  }
});
...
export const resetPassword = createAsyncThunk('auth/resetPassword', async (data, thunkAPI) => {
  try {
    ...
    return thunkAPI.rejectWithValue(err.response?.data?.message || 'Erreur lors de la réinitialisation');
  }
});
